...
// 3.3 ส่งข้อมูลหน้าเว็บกลับไปหาผู้ใช้ (*** ให้นักศึกษาแก้ชื่อ-นามสกุลตรงนี้ ***)
  <body style="background-color:#caeefa; color:#ffffff; font-family:Arial;">
res.end('<h1>สวัสดีครับ! นี่คือ Web Server ของ นายชินพัฒน์ พรประเสริฐ รหัสนักศึกษา 69319010187 ชื่อเล่นชื่อฟีโน่ ชอบฟังเพลง,เล่นเกม,Weight Trainning นิดหน่อย </h1><p>เครื่องแม่ข่ายทํางานปกติบนระบบ Railway แล้วครับผม!</p>');
 });
