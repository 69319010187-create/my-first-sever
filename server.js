...
res.end('<html><body style="background-color: #bee2ed; margin: 0; padding: 20px;"><h1>สวัสดีครับ! นี่คือ Web Server ของ นายชินพัฒน์ พรประเสริฐ รหัสนักศึกษา 69319010187 </h1><p>เครื่องแม่ข่ายทํางานปกติบนระบบ Railway แล้วครับผม!</p></body></html>');
 });
